...
modelo = RandomForestClassifier(n_estimators=500, random_state=0, max_depth=20, max_leaf_nodes=12)
...
plot_tree(tree_to_visualize, filled=True, feature_names=base.columns, class_names=True, rounded=True)
plt.show()
